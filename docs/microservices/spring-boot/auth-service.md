...
spring:
  datasource:
    url: jdbc:mysql://${MYSQL_HOST:localhost}:3306/quckchat_auth
...
public class TotpService {
    ...
    public String generateQrCodeUri(String secret, String email) {
        return String.format(
            "otpauth://totp/QuckChat:%s?secret=%s&issuer=QuckChat",
            email, secret
        );
    }
}
...
```java
// Login events
@KafkaPublish(topic = "quckchat.auth.events")
...
// Security events
@KafkaPublish(topic = "quckchat.security.events")
